#include "RenderCore_SFML.hpp"
#include "SFML/Graphics/CircleShape.hpp"

#define IM_CLAMP(V, MN, MX)     ((V) < (MN) ? (MN) : (V) > (MX) ? (MX) : (V))

void RenderCore_SFML::Init(sf::RenderWindow& window)
{
	IMGUI_CHECKVERSION();
	ImGui::CreateContext();
...
void RenderCore_SFML::Update(sf::RenderWindow *window, std::vector<std::function<void(sf::RenderWindow*)>> callbacks)
{
    /*
    // opt
...
void RenderCore_SFML::Render(sf::RenderWindow& window)
{
    // Render on screen
